  ...
  return (
    <div className="properties-panel">
      ...
      <div className="props-content">
        ...
        {/* Upscale properties */}
        {data.type === "fs:upscale" && <UpscaleProperties nodeId={node.id} data={data} />}

        {/* TikTok Publish properties */}
        {data.type === "fs:tiktokPublish" && <TikTokProperties nodeId={node.id} data={data} />}

        {/* Video Gen Pro properties */}
        {data.type === "fs:videoGenPro" && <VideoGenProProperties nodeId={node.id} data={data} />}
