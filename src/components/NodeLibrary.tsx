    ...
    <div className="node-library-content">
      ...
      <div className="library-list">
        ...
        {(() => {
          ...
          const localTypes = new Set(["fs:localGenerate", "fs:img2img", "fs:kontext", "fs:ltxVideo", "fs:nextFrame", "fs:multiRef", "fs:upscale", "fs:inpaint", "fs:removeBg", "fs:compare", "fs:enhance", "fs:controlNet", "fs:inpaintCN", "fs:prompt", "fs:preview", "fs:import", "fs:characterCard", "fs:scene", "fs:storyboard", "fs:group", "fs:comment"]);
