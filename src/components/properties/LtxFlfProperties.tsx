...
// 20s @ 24fps ≈ 481 frames (workflow's frame calculator rounds to 8n+1).
const MAX_FRAMES = 481;

function LtxFlfProperties({ nodeId, data }: { nodeId: string; data: any }) {
...
export default LtxFlfProperties;
